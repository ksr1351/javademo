...
4. 스트림 종류
   ...
   2)처리 단위로 구분
     바이트 스트림(InputStream,OutputStream) : 바이트 , 배열바이트, 정수바이트
     문자 스트림(Reader,Writer) : 문자, 배열문자, 문자열
...
public class Java161_stream { //stream => 입출력 관련된 class
	
	public static void main(String[] args) {
		
		System.out.print("데이터 입력:");
		
		InputStream is = System.in; //InputStream과 콘솔을 연결함
