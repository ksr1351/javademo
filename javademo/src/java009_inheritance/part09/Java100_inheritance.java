...
public class Java100_inheritance {
	...
	public static void main(String[] args) {
		...
		sPhone[1] = new SmartPhone("삼성","SHV-E1605",180000, "010-2532-5902" , "LG");
		sPhone[2] = new SmartPhone("아이폰","A1586",250000,"010-7280-5283","KT");
